...
<%@ taglib prefix="g" uri="/WEB-INF/tlds/gallery-tags.tld" %>
...
<p>
<g:gallery packageName="/img" thumbSize="350" fullSize="800" showFullQualityDownload="true"/>
</p>
<p>
<g:slideshow packageName="/img" size="500" />
</p>
